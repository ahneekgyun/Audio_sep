...
#from callbacks.base import GradientLoggingCallback
...
# nohup python train.py --workspace workspace/AudioSep --config_yaml config/audiosep_base.yaml --resume_checkpoint_path '' > baseline_Lass 2>&1 &
# python train.py --workspace /home/work/AHN/dcase2024_task9_baseline/workspace/AudioSep --config_yaml /home/work/AHN/dcase2024_task9_baseline/config/audiosep_base.yaml --resume_checkpoint_path ''
# tensorboard --logdir=/home/work/AHN/dcase2024_task9_baseline/lightning_logs

# python train.py --workspace workspace/AudioSep --config_yaml config/audiosep_lavt.yaml --resume_checkpoint_path ''

# nohup python train.py --workspace workspace/AudioSep --config_yaml config/audiosep_lavt.yaml --resume_checkpoint_path '' > 1st_dev_lavt 2>&1 &


# Setting WandB
# Replace 'key' with your personal WandB API key
wandb.login(key='bca829a2b5dbb6949291b14d4e7fa6330bb599fb')

# Define Wandb config
wandb_project = "Audio_sep_lavt"
#wandb_name = "LAAT_swin-base_pretrained_3rd"
wandb_name = "baselin_LASS_DEVDEV"
wandb_entity = "DCASE_T9_SJ"

# This make error stop showing.
...
'''
데이터 모듈 불러오기
config_yaml, num_workers, batch_size를 input으로 받는다
config_yaml을 받아 파싱한 후 데이터모듈을 생성한다.
'''
...
def train(args) -> NoReturn:
    ...
    # logger = TensorBoardLogger("tf_logs", name="LASS_baseline")

    # 수정 체크 검토
    # logger = WandbLogger(project="Audio_sep_lavt", name="baseline_Lass", entity="DCASE_T9_SJ")
    
    logger = WandbLogger(project=wandb_project, name=wandb_name, entity=wandb_entity)
    logger.watch(pl_model, log="all")
