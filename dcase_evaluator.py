...
# config_yaml 파일 경로 지정
def eval(evaluator, checkpoint_path, config_yaml='config/audiosep_lavt.yaml', device = "cuda"):
...
if __name__ == '__main__':
    dcase_evaluator = DCASEEvaluator(
        sampling_rate=16000,
        eval_indexes='/home/work/FSD50K/lass_synthetic_validation.csv',
        audio_dir='/home/work/FSD50K/lass_validation',
    )

    #checkpoint_path='audiosep_16k,baseline,step=200000.ckpt'
    #체크포인트 경로 지정해줘야함
    checkpoint_path='/home/work/AHN/dcase2024_task9_baseline/workspace/AudioSep/checkpoints/train/audiosep_lavt,devices=1/step=120000.ckpt'
